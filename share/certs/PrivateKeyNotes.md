...
allowing somebody to distribute a Bitcoin-Qt.app or wellscoin-qt-setup.exe with a valid
...
that the wellscoin-qt.exe file inside the installer had not been tampered with.
