...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Wellscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"explorer.wellscoin.org", "164.132.58.65"},
    {"pool.wellscoin.org", "79.137.38.85"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"testnet.wellscoin.org", "test.wellscoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Wellscoin is probably already running."), addrBind.ToString().c_str());
        else
